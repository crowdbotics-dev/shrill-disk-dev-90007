"""
Django settings for shrill_disk_dev_90007 project.
...
ROOT_URLCONF = 'shrill_disk_dev_90007.urls'
...
WSGI_APPLICATION = 'shrill_disk_dev_90007.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shrill_disk_dev_90007 API",
    "DESCRIPTION": "API documentation for shrill_disk_dev_90007 App",
    "VERSION": "v1",
}
