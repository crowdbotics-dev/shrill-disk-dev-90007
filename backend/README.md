...
## Project Structure
    ...
    ├── shrill_disk_dev_90007  # Django project configurations
...
1. Clone this repo and `cd shrill_disk_dev_90007`
...
2. Clone this repo and `cd shrill_disk_dev_90007`
